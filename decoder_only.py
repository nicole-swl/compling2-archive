...
def convert_to_token_label_pairs(dataset): #converting data for input
    converted = []
...
def icl_input_formatter_factory(tokenizer):
    system_prompt = (
        ...
        "Labels: B-LOC I-LOC O O O O B-LOC O B-LOC \n\n"
        "Sentence: Pedro Pascal is a handsome man.\n\n"
        "Labels: B-PER I-PER O O O O O \n\n"
        "Sentence: I study in Stanford University.\n\n"
        "Labels: O O O B-ORG I-ORG \n\n"
        "Now process the following sentence. I don't want the extra text. Just "
        "give me the labels."
    )
